defmodule TodolistWeb.Router do
  ...
  scope "/api", TodolistWeb do
    pipe_through :api
    # resources "/users/:user", :index
    get "/users/users", UsersController, :recherche
    resources "/users", UsersController, except: [:new, :edit]
    resources "/workingtimes", WorkingTimesController,  only: [:new, :edit]
    get"/workingtimes/:userId/start/:start/end/:end", WorkingTimesController, :getEndandStartcreate
    ...
    resources "/clocks", ClocksController,  only: [:update, :delete]
